<template>
  <section class="person-query-container">
    <a-form
      layout="inline"
      label-width-auto
    >
        ...
        >
          ...
          >
            <a-select
              ...
              @change="doQuery"
            >
              <a-select-option value="only">仅显示所选单位</a-select-option>
              <a-select-option value="all">含所有下属单位</a-select-option>
            </a-select>
          </a-form-item>
        </div>
