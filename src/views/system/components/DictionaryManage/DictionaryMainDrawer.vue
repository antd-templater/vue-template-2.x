<template>
  <section class="dictionary-main-drawer-container">
    <a-drawer
      width="400"
      :title="title"
      :visible="visible"
...
<script>
import DictionaryMainDrawerForm from './DictionaryMainDrawerForm.vue'

export default {
  name: 'DictionaryMainDrawer',
  components: {
    DictionaryMainDrawerForm
  },
  data () {
    return {
      title: '',
